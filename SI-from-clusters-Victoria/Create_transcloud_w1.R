####################################################################################
### This script creates the 'transmission cloud', for Victorian COVID-19 data wave 1
###
...
min_day_diff <- 1
max_day_diff <- 35
output_filename <- "../data_Victoria/w1_transmission_cloud.csv"
...
write.csv(mdt, "../data_Victoria/epidata_w1clusters.csv")
